...
int main(int argc, char const *argv[])
{
    ...
    auto rotoanShipsForSale = new Vector<Ship*>(true);
    ...
    auto roatanGoods = new Vector<Good*>(true);
    ...
    Vector<HarborDistance*>* harborDistances = new Vector<HarborDistance*>(true);
